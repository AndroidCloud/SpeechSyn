...
pkl_name = 'large_m2_1_best.pkl'
save_name = 'large_m2_1_sample_'
...
[main_lstm, prior, kl,
 ...
 phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_mu, phi_sig,
 prior_1, prior_2, prior_3, prior_4, prior_5, prior_6, prior_mu, prior_sig,
 theta_1, theta_2, theta_3, theta_4, theta_5, theta_6, theta_mu, theta_sig] = nodes
...
def inner_fn(s_tm1):
    ...
    prior_5_t = prior_5.fprop([prior_4_t])
    prior_6_t = prior_6.fprop([prior_5_t])
    prior_mu_t = prior_mu.fprop([prior_6_t])
    prior_sig_t = prior_sig.fprop([prior_6_t])
    ...
    z_5_t = z_5.fprop([z_4_t])
    z_6_t = z_6.fprop([z_5_t])

    theta_1_t = theta_1.fprop([z_6_t, s_tm1])
    theta_2_t = theta_2.fprop([theta_1_t])
    theta_3_t = theta_3.fprop([theta_2_t])
    theta_4_t = theta_4.fprop([theta_3_t])
    theta_5_t = theta_5.fprop([theta_4_t])
    theta_6_t = theta_6.fprop([theta_5_t])
    theta_mu_t = theta_mu.fprop([theta_6_t])
    theta_sig_t = theta_sig.fprop([theta_6_t])
    ...
    x_5_t = x_4.fprop([x_4_t])
    x_6_t = x_4.fprop([x_5_t])
 
    s_t = main_lstm.fprop([[x_6_t, z_6_t], [s_tm1]])
