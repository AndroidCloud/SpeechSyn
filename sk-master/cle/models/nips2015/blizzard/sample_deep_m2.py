...
pkl_name = 'deep_m2_2_30000updates.pkl'
save_name = 'deep_m2_2_30000updates_sample_'
...
def inner_fn(s_1_tm1, s_2_tm1, s_3_tm1):
    ...
    theta_1_t = theta_1.fprop([z_4_t, s_3_tm1])
    ...
    return s_1_t, s_2_t, s_3_t, x_t, theta_mu_t
...
#np.save('deep_m2_5_samples.npy', samples)
