...
print("Latent size is : %d" % latent_size)
...
def inner_fn(x_t, s_1_tm1, s_2_tm1, s_3_tm1):
    ...
    return s_1_t, s_2_t, s_3_t, phi_mu_t, phi_sig_t, z_4_t

((s_1_t, s_2_t, s_3_t, phi_mu_t, phi_sig_t, z_4_t), updates) =\
    theano.scan(fn=inner_fn,
                sequences=[x_4_in],
                outputs_info=[s_1_0, s_2_0, s_3_0, None, None, None])
...
((mn_s_1_t, mn_s_2_t, mn_s_3_t, mn_phi_mu_t, mn_phi_sig_t, mn_z_4_t), mn_updates) =\
    theano.scan(fn=inner_fn,
                sequences=[mn_x_4_in],
                outputs_info=[mn_s_1_0, mn_s_2_0, mn_s_3_0, None, None, None])
...
W_x_t_x_1 = x_1.params['W_x_t__x_1']
col_norm_W_x_t_x_1 = T.sqrt((W_x_t_x_1**2).sum(axis=0))
max_col_norm_W_x_t_x_1 = col_norm_W_x_t_x_1.max()
mean_col_norm_W_x_t_x_1 = col_norm_W_x_t_x_1.mean()
min_col_norm_W_x_t_x_1 = col_norm_W_x_t_x_1.min()
max_col_norm_W_x_t_x_1.name = 'max_col_norm_W_x_t_x_1'
mean_col_norm_W_x_t_x_1.name = 'mean_col_norm_W_x_t_x_1'
min_col_norm_W_x_t_x_1.name = 'min_col_norm_W_x_t_x_1'
...
mn_fn = theano.function(inputs=[mn_x],
                        outputs=[mn_nll_lower_bound, mn_recon_term, mn_kl_term, mn_kl_ratio,
                                 ...
                                 max_col_norm_W_x_t_x_1,
                                 mean_col_norm_W_x_t_x_1,
                                 min_col_norm_W_x_t_x_1],
