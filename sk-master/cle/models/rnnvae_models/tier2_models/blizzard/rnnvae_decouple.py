...
def inner_fn(x_t, x_tm1, enc_tm1, dec_tm1, pec_tm1):
    ...
    return enc_t, dec_t, pec_t, kl_t, phi_sig_t, prior_sig_t, theta_mu_t,\
           theta_sig_t, coeff_t, marginal_ll

((enc_t, dec_t, pec_t, kl_t, phi_sig_t, prior_sig_t, theta_mu_t, theta_sig_t,
  coeff_t, marginal_ll), updates) =\
